...
<?php if (!empty($message)): ?> 
    <div class="alert-error"> 
       ...
       <table class="detail-table"> 
             ...
             </tr> <tr> <th>Correo</th> <td><?= htmlspecialchars($user->getEmail(), ENT_QUOTES, 'UTF-8') ?></td> </tr> <tr> <th>Rol</th> 
...
<td><?= htmlspecialchars($user->getRole(), ENT_QUOTES, 'UTF-8') ?></td>
 ...
 <tr> <th>Estado</th> <td><?= htmlspecialchars($user->getStatus(), ENT_QUOTES, 'UTF-8') ?></td> 
